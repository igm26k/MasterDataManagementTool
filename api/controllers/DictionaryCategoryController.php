...
use app\models\dictionary\DictionaryCategorySearch;
use Yii;
...
/**
 * DictionaryCategoryController implements the CRUD actions for DictionaryCategory model.
 */
class DictionaryCategoryController extends Controller
{
    ...
    /**
     * Lists all DictionaryCategory models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DictionaryCategorySearch();
     ...
     * @param integer $_id
     * @return DictionaryCategory the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DictionaryCategory::findOne($id)) !== null) {
            return $model;
        }
